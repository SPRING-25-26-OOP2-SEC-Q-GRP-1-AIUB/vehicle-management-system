    ...
    public partial class Dashboard : Form
    {
        ...
        private void button1_Click_1(object sender, EventArgs e)
        {
            ...
            SqlCommand cmd5 = new SqlCommand(
                 "SELECT TOP 1 [Car brand], SUM([Ordered cars]) AS MostOrderedCars FROM Orders WHERE [Order status] = 'Accepted' GROUP BY [Car brand] ORDER BY MostOrderedCars DESC;", conn);
